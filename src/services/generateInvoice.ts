...
export function generateInvoice(invoiceData: InvoiceInput) {
  const date = parse(
    invoiceData.infoFactura.fechaEmision,
    "dd/MM/yyyy",
    new Date()
  );
  ...
  const invoice: Invoice = {
    factura: {
      ...
      "@id": "comprobante",
      "@version": "1.0.0",
      // infoTributaria: { claveAcceso: accessKey, ...invoiceData.infoTributaria },
      infoTributaria: {
        ...
        regimenMicroempresas: invoiceData.infoTributaria.regimenMicroempresas,
